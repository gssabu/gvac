 ...
 *   'false' on error.
 */
bool ICM20948::initialize(int16_t offset_gx_1000dps, int16_t offset_gy_1000dps, int16_t offset_gz_1000dps, int16_t offset_ax_32g, int16_t offset_ay_32g, int16_t offset_az_32g, float offset_mx, float offset_my, float offset_mz, float scale_mx, float scale_my, float scale_mz) {
    uint8_t data[1];
 ...
 *   'false' on error.
 */
bool ICM20948::getAcceleration(int16_t &ax, int16_t &ay, int16_t &az) {
 ...
 *   'false' on error.
 */
bool ICM20948::getRotation(int16_t &gx, int16_t &gy, int16_t &gz) {
    static uint8_t data[6];
 ...
 *   'false' else.
 */
bool ICM20948::getHeading(int16_t &mx, int16_t &my, int16_t &mz) {
